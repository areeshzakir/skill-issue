...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-[var(--background)]/80 border-b border-[var(--foreground)]/[0.06]">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="md:hidden text-[var(--muted)] hover:text-[var(--foreground)] transition-colors p-2"
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            className="md:hidden border-t border-[var(--foreground)]/[0.06] bg-[var(--background)]"
